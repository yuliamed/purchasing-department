...
(function() {
    ...
    let saveBtn = document.getElementById("conf11");
    saveBtn.addEventListener('click', function (e) {
        ...
        if (selectedIndex.length < 1) {
            alert("Для смены статуса выберите хотя бы 1 заказ")
            e.preventDefault();
        } else {
            document.getElementById("ids2").value = selectedIndex;
        }
    });
    let saveBtn3 = document.getElementById("conf12");
    saveBtn3.addEventListener('click', function (e) {
        ...
        if (selectedIndex.length < 1) {
            ...
            document.getElementById("ids3").value = selectedIndex;
        }
    });
})();